// Package ichi provides primitives to interact with the openapi HTTP API.
//
...
// Lock a resource.
// (POST /locks)
func (_ Unimplemented) PostLocks(w http.ResponseWriter, r *http.Request, params PostLocksParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Unlock a resource.
// (DELETE /locks/{resource_id})
func (_ Unimplemented) DeleteLocksResourceId(w http.ResponseWriter, r *http.Request, resourceId ResourceId, params DeleteLocksResourceIdParams) {
	w.WriteHeader(http.StatusNotImplemented)
}
